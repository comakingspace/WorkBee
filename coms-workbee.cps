...
description = "WorkBee CoMakingSpace RRF";
vendor = "CoMakingSpace";
vendorUrl = "https://www.comakingspace.org/";
longDescription = "Postprocessor for the 2024 rebuilt WorkBee CNC running RepRapFirmware.";
...
function onCommand(command) {
  ...
  case COMMAND_START_SPINDLE:
    ...
    writeBlock(mFormat.format(tool.clockwise ? 3 : 4), sOutput.format(spindleSpeed), "P0");
    return;
